...
#define CONFIG_ESP32_S2_HMI_DEVKIT_V2_BOARD

#ifdef CONFIG_ESP32_S2_HMI_DEVKIT_V2_BOARD
...
#define GPIO_TWAI_RX        (GPIO_NUM_42)
#define GPIO_TWAI_TX        (GPIO_NUM_41)
